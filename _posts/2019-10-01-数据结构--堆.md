...
tags: [数据结构]
seo:
  date_modified: 2019-10-08 18:25:25 +0800
...
public class Heap<T> {
    ...
    private BiPredicate<T, T> cmp = (a, b) -> a.hashCode() > b.hashCode();

    public Heap(T[] array) {
        this(array, null);
    }

    public Heap(T[] array, BiPredicate<T, T> cmp) {
    ...
    public T removeAt(int i) {
        ...
        if (cmp.test(heap[i], heap[parent(i)])) {
            shiftUp(i);
        } else {
            shiftDown(i);
        }
    ...
    private void shiftUp(int i) {
        ...
        if (cmp.test(heap[i], heap[parent])) {
            swap(i, parent);
            shiftUp(parent);
        }
    }
    ...
    private void shiftDown(int i) {
        ...
        if (cmp.test(heap[left], heap[i])) {
            child = left;
        } else if (cmp.test(heap[right], heap[i])) {
            child = right;
        } else {
            child = -1;
        }
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 构造一个大根堆
        Heap<Integer> heap = new Heap<>(arr, (a, b) -> a > b);
        out.printf(heap.toString());
    }
}
```
